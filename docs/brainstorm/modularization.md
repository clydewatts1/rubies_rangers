...
👉 **[`docs/brainstorm/codebase_modularization_roadmap.md`](./codebase_modularization_roadmap.md)**

Please refer to `codebase_modularization_roadmap.md` for all active specifications, target topology, and historical execution logs.
