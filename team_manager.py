...
from trend_tracker import audit_squad_trends, show_player_deep_dive
from tactical_tracker import audit_squad_tactical, show_league_leaders, show_player_shots
...
def main():
    ...
    if args.command == "audit":
        ...
        if args.mc:
            from montecarlo_tracker import run_montecarlo_cli
