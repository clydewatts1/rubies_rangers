...
CACHE_FILE = os.path.join(_PROJECT_ROOT, ".fpl_cache.json")
FIXTURES_CACHE_FILE = os.path.join(_PROJECT_ROOT, ".fpl_fixtures_cache.json")
ELEMENTS_CACHE_DIR = os.path.join(_PROJECT_ROOT, ".fpl_elements_cache")
